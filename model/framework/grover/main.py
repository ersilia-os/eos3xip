...
if __name__ == '__main__':
    ...
    args = Namespace(batch_size=32, checkpoint_dir=model_path+'/framework/finetune/qm8', checkpoint_path=None, checkpoint_paths=[model_path+'/framework/finetune/qm8/fold_0/model_0/model.pt', model_path+'/framework/finetune/qm8/fold_2/model_0/model.pt', model_path+'/framework/finetune/qm8/fold_1/model_0/model.pt'], cuda=False, data_path=csv_path, ensemble_size=3, features_generator=None, features_path=['features.npz'], fingerprint=False, gpu=0, no_cache=True, no_features_scaling=True, output_path=output_path, parser_name='predict')
